...
<figure>
  <Image src={gym} alt="The fitness/weight room at my local city community centre." class="zoom-image" data-zoom-src="/posts/2025-04-25-going-to-the-gym-for-the-first-time-again/images/gym.jpg" />
...
<div class="flex flex-col md:flex-row items-start gap-6 my-6">
  <div class="flex-1">
    <p>
      Part of the reason why I wanted to go to the gym again was because I also wanted to track my workouts using this swanky new app I found: <a href="https://hevy.com">Hevy</a>. The thing that really attracted me to it was their <a href="https://api.hevyapp.com/docs/">public REST API</a>, which means that I can integrate my workouts and progress on <a href="https://sadman.ca">sadman.ca</a>. I love tracking what I do (including [what I read](https://sadman.ca/posts/what-i-read-in-2024) and [what I watch](https://sadman.ca/posts/what-i-watched-in-2024)), so this was a match made in heaven.
    </p>
    <p>
  ...
  <figure class="flex-1 flex flex-col items-center">
    <Image 
      ...
      class="zoom-image" 
      data-zoom-src="/posts/2025-04-25-going-to-the-gym-for-the-first-time-again/images/hevy-app-screenshot.png" 
      height={500}
    />
...
<figure>
  <Image src={gymPhoto} alt="A photo of me at the gym on my first day back." class="zoom-image" data-zoom-src="/posts/2025-04-25-going-to-the-gym-for-the-first-time-again/images/2025-04-25-first-day-back-at-the-gym.jpg" />
