...
<PhotoSwipe imagePaths={[
  { src: rssInBrowserFull, caption: "Goodreads RSS Feed formatting in FireFox" },
]} />
...
<div class="flex flex-col sm:flex-row gap-4">
  ...
  <PhotoSwipe imagePaths={[
    { src: goodreadsUnstyledImg, caption: "Using the Goodreads collection data in a component (unstyled)" },
  ]} />
</div>
...
<figure>
  ...
  <PhotoSwipe imagePaths={[
    { src: goodreadsTailwindImg, caption: "Goodreads collection data (styled using Tailwind)" },
  ]} />
</figure>
