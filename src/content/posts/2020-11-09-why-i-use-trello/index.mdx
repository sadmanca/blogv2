...
<PhotoSwipe imagePaths={[
  { src: trellokanban, caption: "A kanban board with cards in Trello" },
]} />
...
<PhotoSwipe imagePaths={[
  { src: withincards, caption: "Trello card options including description, due date, checklists, labels, and more" },
]} />
...
<PhotoSwipe imagePaths={[
  { src: howIUseIt, caption: "Example of using Trello to organize schoolwork, side projects, and extracurricular activities" },
]} />
...
<PhotoSwipe imagePaths={[
  { src: powerups, caption: "Examples of Trello Power-Ups including calendar integration, due date countdowns, and cloud service integrations" },
]} />
