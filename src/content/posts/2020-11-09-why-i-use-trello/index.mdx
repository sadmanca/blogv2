...
<Image
  ...
  src={trellokanban}
  layout="constrained"
  alt="A kanban board with cards in Trello"
/>
...
<Image
  src={withincards}
  layout="constrained"
  alt="Trello card options including description, due date, checklists, labels, and more"
/>
...
import howIUseIt from './3_how_i_use_it.png';

<Image
  src={howIUseIt}
  layout="constrained"
  alt="Example of using Trello to organize schoolwork, side projects, and extracurricular activities"
/>
...
<Image
  src={powerups}
  layout="constrained"
  alt="Examples of Trello Power-Ups including calendar integration, due date countdowns, and cloud service integrations"
/>
