...
<PhotoSwipe imagePaths={[
  { src: ece241, caption: "My cheatsheet for an introductory digital logics course, which is a complete mess of different sized blocks of diagrams mixed in with text." },
]} />
