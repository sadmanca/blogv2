...
import fullpage from './01-fullpage.png'
import zoomed from './01-zoomed.png'

<ImageGalleryCaption images={[
  { src: fullpage, caption: "Full page view of cheatsheet" },
  { src: zoomed, caption: "Zoomed in view of cheatsheet" },
]} columns={2} />
...
import latexsheet0 from './latexsheet-0.png'
import latexsheet1 from './latexsheet-1.png'

<ImageGalleryCaption images={[
  { src: latexsheet0, caption: "Front page: sample LaTeX cheatsheet" },
  { src: latexsheet1, caption: "Back page: sample LaTeX cheatsheet" },
]} columns={2} />
...
<ImageGalleryCaption images={[
  { src: typst, caption: "Landing page: Typst" },
  { src: overleaf, caption: "Landing page: Overleaf" },
]} columns={2} />
...
For a good example at what not to do, consider my cheatsheet (below) for an [introductory digital logics course](https://engineering.calendar.utoronto.ca/course/ece241h1) from my second year of university. I can hardly distinguish the different groups of concepts amongst all the differently sized blocks of diagrams mixed in with text, and I was the one who wrote the entire darn thing, I can only imagine how you, dear reader, must feel looking at this spagetthi gobble of a cheatsheet.

import ece241 from './03-ece241.jpg'

<figure>
  <ImageZoom src={ece241} alt="My cheatsheet for an introductory digital logics course, which is a complete mess of different sized blocks of diagrams mixed in with text." class="rounded-xl"/>
  <figcaption>My cheatsheet for an introductory digital logics course, which is a complete mess of different sized blocks of diagrams mixed in with text.</figcaption>
</figure>
...
```python title="aidsheet.typ" caption="Typst allows for importing modules and variables from other .typ files (gray), as well as setting page margins using code (green)." showLineNumbers{0} {1-2}
#import "content.typ": *
#import "lazy.typ": *
...
```python title="content.typ" caption="Example showing how variables of different types (percentage, size: pt/em, color) can be declared in .typ files." showLineNumbers{0} {1-4}
#let img_width = 70%
#let font_size = 3.6pt
