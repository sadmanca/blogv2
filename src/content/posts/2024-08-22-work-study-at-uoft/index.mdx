...
<figure>
  <Image loading="eager" src={d1} alt="Redesigned UofT work study job postings dashboard" class="rounded-xl"/>
...
<figure>
  <ImageZoom src={job_description_page} alt="What a job description page looks like on CLNx" class="rounded-xl"/>
...
<figure>
  <ImageZoom src={d1} alt="Redesigned UofT work study job postings dashboard" class="rounded-xl"/>
  <figcaption>Redesigned UofT work study job postings dashboard at <a href={`${SITE.SITEURL}/uoft-work-study-2024.html`}>sadman.ca/uoft-work-study-2024</a>.</figcaption>
</figure>

<figure>
  <ImageZoom src={d2} alt="Zoomed-in view of redesigned UofT work study job postings dashboard" class="rounded-xl"/>
