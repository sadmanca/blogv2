...
<figure>
  <ImageZoom class="rounded-xl" src={peyLoginImage} alt="PEY job board login portal" />
  <figcaption>The PEY job board login portal at <a href="https://www.uoftengcareerportal.ca/notLoggedIn">https://www.uoftengcareerportal.ca/notLoggedIn</a></figcaption>
</figure>
...
<ImageGalleryCaption images={[
  { src: a2, caption: "The PEY Co-op job board landing page (Job Postings)" },
  { src: a1, caption: "Advanced search options (Search Job Postings)" },
]} columns={2} />

import viewedjobs from './01-pey-viewed.jpg';

<figure>
  <ImageZoom class="rounded-xl" src={viewedjobs} alt="PEY Co-op job board viewed jobs" />
...
<ImageGalleryCaption images={[
  { src: a4, caption: "Old design for PEY job postings. One of the earliest jobs to be posted on the job board for my cohort (2T5) in 2023. Shown: ML Developer - Software Automation & Developer Infrastructure @ Cerebras" },
  { src: a5, caption: "Current design for PEY job postings. One of the most recent jobs posted at the time of writing. Shown: Software Developer Intern @ Geotab" },
]} columns={2} />
...
<ImageGalleryCaption images={[
  { src: "https://imgs.xkcd.com/comics/is_it_worth_the_time.png", caption: "xkcd: 'Is It Worth the Time?'", width: 740, height: 274 },
  { src: "https://imgs.xkcd.com/comics/automation.png", caption: "xkcd: 'Automation'", width: 740, height: 274 },
]} columns={2} />
...
```html title="Job ID 43628 UofT Engineering Career Centre...Job Postings (9_18_2023 12_52_04 AM).html" caption="The page for the Cerebras position above has 3506 empty lines with only 809 lines dedicated to actual code, and the HTML code on non-empty lines isn't exactly the most pleasing to read."
...
```txt title="Output of above command" caption="Output of the parse.py script for the Cerebras job posting." {2-4, 7-9}
...
```sql caption="SQLite query for: How many job postings are there for mechatronics positions?" {3-9}
