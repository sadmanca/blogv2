...
import sampleHtml from './ML Developer – Software Automation & Dev Infra Intern - ML Developer – Software Automation & Dev Infra Intern (2024-09-17 10_38_07 PM).html?raw'
...
<div class="flex flex-col md:flex-row gap-4 my-6">
  <figure class="flex-1 m-0">
    <Image src={a2} alt="The PEY Co-op job board landing page (Job Postings)" class="zoom-image" data-zoom-src="/posts/2024-05-22-analyzing-pey-postings-part-1/01-pey-landing-page.jpg" />
    <figcaption>The PEY Co-op job board landing page (Job Postings)</figcaption>
  </figure>

  <figure class="flex-1 m-0">
    <Image src={a1} alt="Advanced search options (Search Job Postings)" class="zoom-image" data-zoom-src="/posts/2024-05-22-analyzing-pey-postings-part-1/01-pey-advanced-search.jpg" />
...
<div class="flex flex-col md:flex-row gap-4 my-6">
  <figure class="flex-1 m-0">
    <Image src={viewedjobs} alt="Viewed jobs (Viewed)" class="zoom-image" data-zoom-src="/posts/2024-05-22-analyzing-pey-postings-part-1/01-pey-viewed.jpg" />
...
<div class="flex flex-col md:flex-row gap-4 my-6">
  ...
  <figure class="flex-1 m-0">
    <Image src={a5} alt="Current design for PEY job postings. One of the most recent jobs posted at the time of writing. Shown: Software Developer Intern @ Geotab" class="zoom-image" data-zoom-src="/posts/2024-05-22-analyzing-pey-postings-part-1/02-pey-sample-posting.jpg" />
...
<div class="flex flex-col md:flex-row gap-4 my-6">
  <figure class="flex-1 m-0">
    <Image src={isitworth} alt="xkcd: 'Is It Worth the Time?'" class="zoom-image" data-zoom-src="/posts/2024-05-22-analyzing-pey-postings-part-1/is_it_worth_the_time.png" />
    <figcaption>xkcd: ['Is It Worth the Time?'](https://xkcd.com/1205/)</figcaption>
  </figure>

  <figure class="flex-1 m-0">
    <Image src={automation} alt="xkcd: 'Automation'" class="zoom-image" data-zoom-src="/posts/2024-05-22-analyzing-pey-postings-part-1/automation.png" />
...
```python title="parse.py" ins={"      ## quirk with SingleFile: you still have boilerplate HTML": 7-8} {5-23} collapse={29-9999999}
import argparse
from bs4 import BeautifulSoup
import re
