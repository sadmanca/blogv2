...
<PhotoSwipe imagePaths={[
  { src: peyLoginImage, caption: 'The PEY job board login portal at <a href="https://www.uoftengcareerportal.ca/notLoggedIn">uoftengcareerportal.ca/notLoggedIn</a>' },
]} />
...
<PhotoSwipe imagePaths={[
  { src: viewedjobs, caption: 'Viewed jobs (Viewed)' },
]} />
...
<PhotoSwipe imagePaths={[
  { src: isitworth, caption: "xkcd: 'Is It Worth the Time?'" },
  { src: automation, caption: "xkcd: 'Automation'" },
]} />
