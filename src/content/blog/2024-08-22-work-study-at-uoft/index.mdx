...
import d1 from './04-new-work-study-job-dashboard.png';
import d2 from './04-zoom-in.png';

## A better way to view work study job postings at UofT

**I made an easier way to view work study jobs for this year**, and you can check it out at <br></br>**<a href={`${SITE.SITEURL}/uoft-work-study-2024`}>sadman.ca/uoft-work-study-2024</a>**.

<figure>
  <Image src={d1} alt="Redesigned UofT work study job postings dashboard" class="rounded-xl"/>
  <figcaption>Redesigned UofT work study job postings dashboard at <a href="{`${SITE.SITEURL}/uoft-work-study-2024}">sadman.ca/uoft-work-study-2024</a>.</figcaption>
</figure>

If you're interested in applying to work study jobs right now ~~*(applications are still open!)*~~ or want to explore what jobs are posted so you can better prepare in the future, then try taking a look (and let me know what you think!). While work study job postings on CLNx disappear if you don't view them before their respective application deadline, their data is archived on the dashboard so *they remain visible even after their application deadline passes*.

## Work Study: (Underappreciated) Part-time <br></br>Employment for Students
...
<ImageGalleryCaption images={[
  { src: landing, caption: "CLNx landing page before login" },
  { src: home, caption: "CLNx home page after user login" },
]} columns={2} />
...
<ImageGalleryCaption images={[
  { src: i1, caption: "CLNx job board landing page with search options" },
  { src: i2, caption: "CLNx job listings page showing various job postings" },
]} columns={2} />

import job_description_page from './03-example-job.png';

<figure>
  <Image src={job_description_page} alt="What a job description page looks like on CLNx" class="rounded-xl"/>
...
**The dashboard is live and you can view it at <a href={`${SITE.SITEURL}/uoft-work-study-2024`}>sadman.ca/uoft-work-study-2024</a>**.
...
<figure>
  <Image src={d2} alt="Zoomed-in view of redesigned UofT work study job postings dashboard" class="rounded-xl"/>
  <figcaption>**Zoomed-in view.** Redesigned UofT work study job postings dashboard at <a href={`${SITE.SITEURL}/uoft-work-study-2024`}>sadman.ca/uoft-work-study-2024</a>.</figcaption>
</figure>
