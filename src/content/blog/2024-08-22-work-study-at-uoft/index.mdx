...
<Callout type="info" classes="bg-blue-950">
  **There’s an easier to view work study jobs for this year** and you can check it out at <br></br>**<a href={`${SITE.SITEURL}/uoft-work-study-2024`}>sadman.ca/uoft-work-study-2024</a>** (preview below).
</Callout>
...
<Callout type="info" icon="lucide:badge-check" classes="bg-green-950">
...
<Callout type="info" classes="bg-green-950">
