...
## A dashboard with every co-op/internship job posting on the UofT PEY Portal (for the 2023-2024 academic year)
...
<div>
  <video class="rounded-xl" width="100%" height="360" controls>
    <source src="/src/content/blog/2024-09-10-pey-coop-jobs-at-uoft/dashboard.mp4" type="video/mp4" />
...
That's why I built a dashboard of all the jobs that were posted while I had access to the PEY portal at **h<a href={`${SITE.SITEURL}/uoft-pey-coop-jobs-2023`}>sadman.ca/uoft-pey-coop-jobs-2023</a>**.
