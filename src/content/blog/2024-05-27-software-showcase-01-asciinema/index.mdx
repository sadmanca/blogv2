...
<Callout type="info" icon="lucide:meh">
...
<script id="asciicast-QmYHMiHpK8i7J0CZJoOxgUeDw" src="https://asciinema.org/a/QmYHMiHpK8i7J0CZJoOxgUeDw.js" data-speed="1.75" data-autoplay="false" data-loop="true" data-preload="false" data-cols="80" data-rows="8" data-size="small" async></script>
...
<script id="asciicast-9593" src="https://asciinema.org/a/9593.js" data-speed="2.8" data-autoplay="false" data-loop="true" data-preload="false" async></script>
**Shown:** _"Iterative git rebase with vim"_. **Source:** https://asciinema.org/a/9593.
...
<Callout type="flag">
  **Below**: The resulting embedded `asciinema` recording *with additional configuration and a zoomed out view.*
</Callout>
...
![An animated SVG generated from an `asciinema` recording using `svg-term-cli`.](./02-svg-term-cli.svg)
